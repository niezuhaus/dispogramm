    ...
    <div class="flex flex-column">
      ...
      <div class="flex flex-row justify-content-between">
        <mat-form-field style="width: 200px">
          ...
          <input matInput [(ngModel)]="regularJob._startDate" [matDatepicker]="pickerStart" (click)="pickerStart.open()" [formControl]="ctrlStartDate" (dateChange)="dateChange($event.value)" />
      ...
      <div class="flex flex-row justify-content-between">
        ...
        <button *ngIf="regularJob.id && tourplan" (click)="delete()" mat-button class="mt-3 fex-button-warn">ab {{ tourplan.date.dateStampShort() }} streichen</button>
      </div>
    </div>
  `,
  styles: [
...
export class RegularJobDialogComponent implements OnInit {
  ...
  dateChange(date: Date | any): void {
    ...
    this.regularJob.startDate.datesSet().forEach((d, i) => {
   ...
   * @private
   */
  public static findnext(day: Day, from: Date, obj: Date): Date {
    obj.copyDate(from);
