          ...
          <div class="flex flex-column pb-4 px-4">
            ...
            <div class="flex flex-row">
              <div class="flex flex-column align-items-center day">
                ...
                <timepicker
                  [(time)]="regularJob.dates[0]"
                  (timeChange)="timeSync($event)"
                  [disabled]="!datesChecked[0]"
            ...
            <div class="mt-3 flex flex-row">
              <mat-form-field style="width: 200px">
                ...
                <input
                  matInput
                  type="number"
                  [(ngModel)]="regularJob.monthlyPrice._netto"
                  [formControl]="ctrlMonthlyPrice"
                  required
                  [errorStateMatcher]="saveAttemptMatcher"
                />
