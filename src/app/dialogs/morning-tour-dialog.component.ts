  ...
  template: `
    ...
    <table mat-table [dataSource]="dataSource" matSort matSortActive="date" matSortDirection="asc" class="h-100" style="overflow-y: scroll">
      <ng-container matColumnDef="date">
        ...
        <td mat-cell *matCellDef="let element">
          <div class="flex flex-row justify-around align-items-center">
            ...
            <span [matTooltip]="'disponiert von ' + element._job.dispatcher?.nickname">
      ...
      <ng-container matColumnDef="messenger">
        ...
        >
          <messenger-selector (messengerSelect)="tourplan?.calcSales()" [checkedIn]="tourplan?.checkedIn" [earlyShift]="tourplan?.earlyShift" [lateShift]="tourplan?.lateShift" [item]="element">
          </messenger-selector>
        </td>
      </ng-container>
      <ng-container matColumnDef="traveldist">
        <th mat-header-cell *matHeaderCellDef mat-sort-header class="text-center" style="width: 100px"><span class="ml-4">streckenlänge</span></th>
    ...
    <div class="container">
      ...
      <mat-menu #rightMenu="matMenu">
        <ng-template matMenuContent let-item="item">
          <right-click-menu [item]="item"> </right-click-menu>
        </ng-template>
      </mat-menu>
    </div>
  `,
